 ...
 *         Draw → pełny zwrot bez prowizji.
 *         Brak ruchu gracza 2 (state Open) → gracz 1 wygrywa przez claimTimeout.
 */
contract RockPaperScissors {
    ...
    uint256 public constant BET = 0.0005 ether;
    ...
    // ── Gracz 1 odbiera wygraną gdy gracz 2 nigdy nie dołączył (state Open) ─
    ...
    function _finish(uint256 gameId) internal {
        ...
        if (winner == address(0)) {
            // Remis — zwrot pełny, bez prowizji
